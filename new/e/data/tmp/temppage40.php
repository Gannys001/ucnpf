    ...
    <div class="container">
      	...
      	<div id="main_content" class="span-24">
      		<div id="subnavi" class="span-5">
      			...
      			<li class="active"><a href="/zh-cn/diplomacy.html">民间交流</a></li>
               <li><a href="/zh-cn/education.html">培养未来领袖</a></li>
      			</ul>
      		...
      		<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select * from {$dbtbpre}ecms_news where id='81'",0,24,0);
if($ecms_bq_sql){
