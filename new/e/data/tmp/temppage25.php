...
<html lang="en">
  <head profile="http://www.w3.org/2005/10/profile">
	...
	<link rel="stylesheet" href="/css/global.css" type="text/css" media="screen, projection, print">
  	...
  	<link rel="stylesheet" href="/css/about.css" type="text/css" media="screen, projection, print">
    ...
    <div class="container">
      	...
      	<div class="span-24 globalnavi">
      		<ul class="main_nav">
				...
				<li class="active"><a href="/zh-cn/introduction.html" class="navi">关于我们</a></li>
      	...
      	<div id="main_content" class="span-24">
      		<div id="subnavi" class="span-5">
      			...
      			<ul class="border">
      				<li><a href="/zh-cn/introduction.html">基金会简介</a></li>
      				<li><a href="/zh-cn/scope.html">业务范围</a></li>
      				<li class="active"><a href="/zh-cn/orgnization.html">组织架构</a></li>
      				<li><a href="/zh-cn/publication.html">官方媒体</a></li>
      			</ul>
      			<div id="bottomborder"></div>
      		</div>
      		<div class="span-17 last push-1" style="min-height: 600px">
      			<h2  style="margin-bottom:2em;">组织架构</h2>
      			<div>
      				<p  style="text-indent:2em; font-size:15px;line-height:3em;">为保证基金的合理使用，使基金会的活动符合其宗旨及国家法律的要求，基金会设以下机构：</p>
      				<div  style="margin-left:200px;margin-bottom:2em;"><img width="250" height="200" src="/images/shared/dongshihui.png" alt=""/></div>
<p  style="text-indent:2em; font-size:15px;line-height:3em;">董事会为基金会最高领导机构，由董事长、执行董事、发起董事和一般董事组成，负责决定基金会的规章制度、发展方向和人事任免等。董事会选举产生董事长、执行董事，在董事会休会期间，董事长、执行董事负责决策基金会的重大事项。</p>
<div  style="margin-left:200px;margin-bottom:2em;"><img width="250" height="200" src="/images/shared/lishihui.jpg" alt=""/></div>
<p  style="text-indent:2em; font-size:15px;line-height:3em;">理事会作为基金会的咨询顾问机构，由资深专家学者、业内知名人士及一般捐款人组成，为基金会的发展规划、项目选题、成果验收等提供指导与建议。理事任期为五年。</p>
      			</div>
      		</div>
      </div>
      	<!--Footer-->
