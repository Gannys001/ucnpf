  ...
  <body>
    ...
    <div class="container">
      	...
      	<div id="main_content" class="span-24">
      		...
      		<ul class="border">
      			<li style="padding:0;height:62px;line-height:1.3em;"><a href="/en/fankong.html">Third Annual Sino-U.S. Counterterrorism Dialogue</a></li>
      			<li style="padding:0;height:62px;line-height:1.3em;"><a href="/en/jiuri.html">Screening Mr. Deng Goes to Washington in the U.S.</a></li>
      			<li style="padding:0;height:62px;line-height:1.3em;"><a href="/en/jiaoliu.html">Chinese and Japanese Scholar Exchange Program</a></li>
      			<li class="active" style="padding:0;height:62px;line-height:1.3em;"><a href="/en/chaohe.html">Sino-Japan Dialogue: Nuclear Issue on Korean Peninsula</a></li>
      			<li style="padding:0;height:62px;line-height:1.3em;"><a href="/en/minjianwaijiao.html">The Report of the Chinese Civil Diplomacy</a></li>
      			<li style="padding:0;height:62px;line-height:1.3em;"><a href="/en/fanghua.html">U.S. Mayors Delegation Visit to China</a></li>
      			<li style="padding:0;height:62px;line-height:1.3em;"><a href="/en/junguan.html">U.S. – China Young Military Cadets Exchange Program</a></li>
      			<li style="padding:0;height:45px;line-height:1.3em;"><a href="/en/lunwen.html">New Perspectives: Call for Papers</a></li>
      			<li style="padding:0;height:45px;line-height:1.3em;"><a href="/en/hegui.html">International Compliance Forum</a></li>
      			</ul>
      		...
      		<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select * from {$dbtbpre}ecms_news_data_1 where id='72' ",0,24,0);
if($ecms_bq_sql){
      		...
      		<div class="span-17 last push-1">
      			<p class="quiet time">&nbsp;</p>
   			    <div align="left" class="STYLE10">
   			      <p class="STYLE10">Sino-Japan Dialogue: Nuclear Issue on Korean Peninsula</div>
	          <div class="program" style="text-indent:2em;line-height:3em"><?=$bqr[newstext]?></div>
	          <br>
	          <br>
	          <div><img  width="670px" src="/zh-cn/chaohe/chaohe.png" alt=""></div>
      		</div>	
      		<?php
}
}
