...
<html lang="en">
  <head profile="http://www.w3.org/2005/10/profile">
	...
	<link rel="stylesheet" href="/css/global.css" type="text/css" media="screen, projection, print">
  	...
  	<link rel="stylesheet" href="/zh-cn/css/about.css" type="text/css" media="screen, projection, print">
    ...
    <div class="container">
      	...
      	<div class="span-24 globalnavi">
      		<ul class="main_nav">
				...
				<li class="active"><a href="/en/introduction.html" class="navi">ABOUT US</a></li>
      	...
      	<div id="main_content" class="span-24">
      		<div id="subnavi" class="span-5">
      			...
      			<ul class="border">
      				...
      				<li class="active"><a href="/en/mission.html">Mission</a></li>
      				<li><a href="/en/organization.html">Organization</a></li>
      				<li><a href="/en/publication.html">Media Platforms</a></li>
      			</ul>
      			<div id="bottomborder"></div>
      		</div>
      		<div class="span-18 last push-1" style="min-height: 600px">
      			<div id="about_content">
      				<div class="left leader_thumb">
      				<div class="clear">
      				<p style=" font-size:15px;line-height:3em;">
      				<strong>Research:</strong> Geopolitics, focusing on U.S.-China relations and other related Asia-Pacific affairs;<br/>
<strong>Interpret Policy:</strong> To invite well-known scholars to interpret the policies of the U.S. and China, and release their findings to the public with the help of Chinese and foreign media platforms;<br/>
<strong>International Cooperation:</strong> To cooperate with the think tanks from the U.S. and Japan in international research projects;<br/>
<strong>International Visits:</strong>To organize for Chinese scholars, enterprises, and media organizations to visit foreign countries, and to organize visits for foreign scholars and associated personages to China;<br/>
<strong>Training:</strong> To offer training for people interested in critical issues in the international political, economic, and social fields.</p>
</div>
