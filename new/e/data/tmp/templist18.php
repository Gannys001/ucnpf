...
<html lang="en">
  <head profile="http://www.w3.org/2005/10/profile">
    ...
    <title>The U.S.-China New Perspectives Foundation - News</title>
    ...
    <div class="container">
      	...
      	<div id="main_content" class="span-24">
      		<div id="subnavi" class="span-5">
      			...
      			<ul class="border">
      				<li ><a href="/en/news/">NPF News</a></li>
      				<li class="active"><a href="/en/related/">Video</a></li>
      			</ul>
      			<div id="bottomborder"></div>
      		</div>
      		<div id="news_content" class="span-17 last" style="min-height:800px">
      			<h3 id="about_title">Video</h3>
                        [!--empirenews.listtemp--]
