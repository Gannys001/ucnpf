    ...
    <div class="container">
      	...
      	<div id="main_content" class="span-24">
      		...
      		<ul class="border">
      			...
      			<li class="active" style="padding:0;height:45px;line-height:1.3em;"><a href="/en/hegui.html">International Compliance Forum</a></li>
      			</ul>
      		...
      		<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select * from {$dbtbpre}ecms_news_data_1 where id='73' ",0,24,0);
if($ecms_bq_sql){
      		...
      		<div class="span-17 last push-1">
      			<p class="quiet time">&nbsp;</p>
   			    <div align="left" class="STYLE10">
   			      <p class="STYLE10">International Compliance Forum</div>
