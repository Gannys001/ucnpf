    ...
    <div class="container">
      	...
      	<div id="main_content" class="span-24">
      		<div id="subnavi" class="span-5">
      			...
      			<ul class="border">
      			<li ><a href="/zh-cn/policy.html">政策性研究</a></li>
      			<li ><a href="/zh-cn/diplomacy.html">民间交流</a></li>
               <li class="active"><a href="/zh-cn/education.html">培养未来领袖</a></li>
      			</ul>
      		...
      		<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select * from {$dbtbpre}ecms_news where id='82'",0,24,0);
if($ecms_bq_sql){
...
?>
	          ...
	          <p align="center">&nbsp;</p>
	          <p align="center">&nbsp;</p>
	          <div class="program" style="text-indent:2em;line-height:2em;font-size: 20px"><?=$bqr[smalltext]?></div>
      		</div>
