    ...
    <div class="container">
      	...
      	<div id="main_content" class="span-24">
      		<div id="subnavi" class="span-5">
      			...
      			<li class="active"><a href="/zh-cn/fanghua.html">美国市长代表团访华</a></li>
      		...
      		<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select * from {$dbtbpre}ecms_news where id='38' order by newstime desc limit 6 ",0,24,0);
if($ecms_bq_sql){
...
?>
	          ...
	          <br>
	          <br>
	          <div><img  width="670px" src="/zh-cn/fanghua/fanghua.png" alt=""></div>
      		</div>
