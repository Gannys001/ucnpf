    ...
    <div class="container">
      	...
      	<div id="main_content" class="span-24">
      		<div id="subnavi" class="span-5">
      			...
      			<li class="active"><a href="/zh-cn/lunwen.html">新视角”论文颁奖典礼</a></li>
      		...
      		<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select * from {$dbtbpre}ecms_news where id='40' order by newstime desc limit 6 ",0,24,0);
if($ecms_bq_sql){
