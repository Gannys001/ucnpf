    ...
    <div class="container">
      	...
      	<div class="span-24 globalnavi">
      		<ul class="main_nav">
				...
				<li class="active"><a href="/zh-cn/magazine.html" class="navi">新视角杂志</a></li>
      	...
      	<div id="main_content" class="span-24">
      		<div id="subnavi" class="span-5">
      			...
      			<ul class="border">
      				<li><a href="/zh-cn/news/">基金会新闻</a></li>
      				<li  class="active"><a href="/zh-cn/xiangguanxinwen/">相关新闻</a></li>
      			</ul>
      			<div id="bottomborder"></div>
      		</div>
      		<div id="news_content" class="span-17 last" style="min-height:800px">
      			<h3 id="about_title">相关新闻</h3>
                        [!--empirenews.listtemp--]
