    ...
    <div class="container">
      	...
      	<div id="main_content" class="span-24">
      		<div id="subnavi" class="span-5">
      			...
      			<ul class="border">
      			<li class="active"><a href="/zh-cn/fankong.html">中美国际反恐学术研讨会</a></li>
      			...
      			<li><a href="/zh-cn/junguan.html">中美青年军官交流</a></li>
      		...
      		<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select * from {$dbtbpre}ecms_news where id='25' order by newstime desc limit 6 ",0,24,0);
if($ecms_bq_sql){
...
?>
      		      <div class="clearfix">
        <div class="block block02 large reports wid-1 fl wid-baodao">
        <div class="blk-hd clearfix">
          <h2 class="blk-title fz20 cur">详情</h2>
        </div>
        <div class="blk-bd">
          <ul class="list_line2 hide" style="display: block;"> 
                       <li class="clearfix first">
              <dl>
              <dt class="fl"><a class="img" href="/zh-cn/fankongri.html"><img src="/zh-cn/fankong/fankong1.jpg" alt=""></a></dt>
                <dd class="text-box">
                  <h3 class="title mb20 fz16"><a href="/zh-cn/fankongri.html"><!--i>&bull;&nbsp;&nbsp;</i-->2016中美国际反恐学术研讨会议程</a></h3>
                  <p class="text"></p>
                </dd>
              </dl>
            </li> 
           <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select * from {$dbtbpre}ecms_news where classid='17' order by newstime desc limit 6 ",0,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
?>
           <li class="clearfix first">
              <dl>
                <dt class="fl"><a class="img" href="<?=$bqr[titleurl]?>"><img src="<?=$bqr[titlepic]?>" alt=""></a></dt>
                <dd class="text-box">
                  <h3 class="title mb20 fz16"><a href="<?=$bqr[titleurl]?>"><!--i>&bull;&nbsp;&nbsp;</i--><?=$bqr[title]?></a></h3>
                  <p class="text"><?=$bqr[smalltext]?> </p>
                </dd>
              </dl>
            </li>
            <?php
...
?>             
      ...
      <!--
       <div class="block block02 schedule wid-4 ml-4 fr">
          <div class="blk-hd">
            <h2 class="blk-title fz20" style="line-height:1.5em;">历届中美国际反恐学术研讨会议程</h2>
          </div>
          <div class="blk-bd">
<h3 class="blk-title fz20" style="padding:35px 7%;"><a href="/zh-cn/fankongri.html">2016中美国际反恐学术研讨会议程</a></h3>
          </div>
        </div>
      </div>
      	 -->    	
