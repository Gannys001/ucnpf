    ...
    <div class="container">
      	...
      	<div id="main_content" class="span-24">
      		<div id="subnavi" class="span-5">
      			...
      			<li class="active"><a href="/zh-cn/jiuri.html">《旋风九日》美国放映活动</a></li>
      		...
      		<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select * from {$dbtbpre}ecms_news where id='24' order by newstime desc limit 6 ",0,24,0);
if($ecms_bq_sql){
...
?>
        ...
        <div class="blk-bd">
          <ul class="list_line2 hide" style="display: block;"> 
              ...
              <dl>
              <dt class="fl"><a class="img" href="/zh-cn/jiuri.html"><img src="/zh-cn/jiuri/jiuri.jpg" alt=""></a></dt>
                <dd class="text-box">
                  <h3 class="title mb20 fz16"><a href="/zh-cn/jiuriri.html">《旋风九日》美国放映活动日程表</a></h3>
                  <p class="text"></p>
                </dd>
              </dl>
            </li> 
           <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select * from {$dbtbpre}ecms_news where classid='18' order by newstime desc limit 6 ",0,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
