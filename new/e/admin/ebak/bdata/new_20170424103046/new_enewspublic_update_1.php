...
E_D("DROP TABLE IF EXISTS `new_enewspublic_update`;");
E_C("CREATE TABLE `new_enewspublic_update` (
...
E_D("replace into `new_enewspublic_update` values('1','1355124469','1355124476','76','0','|1,74|4,2|','','1491444368','1491444368','1','2','0','0');");
