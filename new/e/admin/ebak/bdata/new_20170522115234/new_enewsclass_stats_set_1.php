...
E_D("DROP TABLE IF EXISTS `new_enewsclass_stats_set`;");
E_C("CREATE TABLE `new_enewsclass_stats_set` (
...
E_D("replace into `new_enewsclass_stats_set` values('1','3600','0','20130717');");
