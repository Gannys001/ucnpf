...
$ecms_config['db']['dbpassword']='NewSql.2017!@#';	//数据库密码
$ecms_config['db']['dbname']='new';	//数据库名
$ecms_config['db']['setchar']='utf8';	//设置默认编码
$ecms_config['db']['dbchar']='utf8';	//数据库默认编码
$ecms_config['db']['dbtbpre']='new_';	//数据表前缀
...
$ecms_config['esafe']['ecookiernd']='QeTSeRo6lhCyp4aeOEGtb8KF4l0UYC';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='kaaal';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='fvpww';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='s0E01uJKCmSfROr3i9plrMLyPuyoFO';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='H9rw3yvLskLWQMVGNAxUGbSkrnqiGE';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)

//网站防火墙配置
$ecms_config['fw']['eopen']=0;	//开启防火墙(0为关闭,1为开启)
$ecms_config['fw']['epass']='XB2aKLAMf3mAF76zThPCCTG0eGzFFi6qRSZa';	//防火墙加密密钥(填写10~50个任意字符，最好多种字符组合)
$ecms_config['fw']['adminloginurl']='http://www.ucnpf.org';	//允许后台登陆的域名,设置后必须通过这个域名才能访问后台
$ecms_config['fw']['adminhour']='8,9,10,11,12,14,15,16,17,18';	//允许登陆后台的时间：0~23小时，多个时间点用半角逗号格开
$ecms_config['fw']['adminweek']='1,2,3,4,5';	//允许登陆后台的星期：星期0~6，多个星期用半角逗号格开
$ecms_config['fw']['adminckpassvar']='org.ucnpf.www';	//后台预登陆验证变量名
$ecms_config['fw']['adminckpassval']='d7yR04RFW125QRFmVu5My6mpXZR4D84mt16B';	//后台预登陆认证码
...
//------------e_public
$public_r=array('sitename'=>'美中新视角基金会',
'newsurl'=>'/',
'filetype'=>'|.gif|.jpg|.swf|.rar|.zip|.mp3|.wmv|.txt|.doc|.png|.mp4|.flv|',
'filesize'=>45000,
'relistnum'=>8,
'renewsnum'=>100,
'min_keyboard'=>2,
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'DF9O3hjVdPbTFMAIckgPmG15XRr72x',
'checkdorepstr'=>',2,0,0,0,',
'regkey_ok'=>0,
'opengetdown'=>0,
'gbkey_ok'=>0,
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/en/\">English</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'intb'=>0,
'mid'=>8);
$etable_r['program']=Array('deftb'=>'1',
'yhid'=>0,
'intb'=>0,
'mid'=>0);
...
'definfovoteid'=>0,
'orderf'=>'',
'sonclass'=>'|3|5|6|7|34|16|17|18|19|20|21|22|23|30|32|33|31|35|36|37|38|39|40|42|43|',
'tid'=>1,
'tbname'=>'news');
